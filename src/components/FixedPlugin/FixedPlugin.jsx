...
class FixedPlugin extends Component {
  ...
  render() {
    return (
      <div className="fixed-plugin" hidden> {/* edy fixed */}
            ...
            <li className="adjustments-line">
              <a className="switch-trigger">
                ...
                <div className="pull-right">
                  ...
                  <span
                    className={
                      this.props.bgColor === "darktwitter"
                        ? "badge filter badge-darktwitter active"
                        : "badge filter badge-darktwitter"
                    }
                    data-color="darktwitter"
                    onClick={() => {
                      this.props.handleColorClick("darktwitter");
                    }}
                  />
                  {/* <span
                    className={
